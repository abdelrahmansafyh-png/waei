  ...
  return (
    <main dir="rtl" className="relative min-h-screen overflow-hidden bg-[#F5FBFF] text-[#14224A]">
      <style>{`
        ...
        .auth-input{height:58px;width:100%;border-radius:22px;border:1px solid rgba(14,159,170,.18);background:rgba(255,255,255,.92);padding:0 54px 0 18px;font-weight:800;outline:none;color:#14224A;box-shadow:0 10px 28px rgba(20,34,74,.06);transition:.2s ease}
        ...
        <section className="hidden lg:block auth-fade-up">
          <div className="relative overflow-hidden rounded-[46px] auth-glass p-10">
            ...
            <h1 className="mt-7 max-w-2xl text-6xl font-black leading-[1.18] tracking-[-.03em] text-[#101B3D]">
              ...
              <br />
              جاهز نكمل
              <span className="text-[#0E9FAA]"> رحلة راشد؟</span>
            </h1>
          ...
          <form onSubmit={handleChildLogin} className="relative mx-auto max-w-[520px] overflow-hidden rounded-[42px] auth-glass p-6 md:p-9">
            ...
            <div className="relative z-10">
              <div className="mb-8 text-center">
                ...
                <h2 className="text-4xl font-black text-[#101B3D] md:text-5xl">أهلاً يا بطل</h2>
                <p className="mt-4 text-lg font-bold leading-8 text-[#566681]">اكتب بيانات الدخول التي أنشأها ولي الأمر.</p>
              </div>
              ...
              <div className="space-y-5">
                ...
                <button disabled={loading} className="w-full rounded-full bg-gradient-to-r from-[#19C6D4] to-[#0E9FAA] py-4 text-lg font-black text-white shadow-xl shadow-[#19C6D4]/25 transition hover:-translate-y-1 disabled:opacity-50">
                  {loading ? "جاري الدخول..." : "ادخل إلى حسابي"}
                </button>

                <div className="flex flex-wrap justify-center gap-4 pt-2 text-sm font-black">
                  <Link href="/login" className="text-[#0E9FAA] hover:text-[#087985]">دخول ولي الأمر</Link>
                  <Link href="/register" className="text-[#8B5CF6] hover:text-[#6847F5]">إنشاء حساب ولي أمر</Link>
                </div>
              </div>
            </div>
          </form>
