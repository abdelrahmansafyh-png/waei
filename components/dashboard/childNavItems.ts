export const childNavItems = [
  { label: "الرئيسية", icon: "/images/waei-child/icons/home-3d.svg", href: "/dashboard" },
  { label: "البرامج", icon: "/images/waei-child/icons/programs-3d.svg", href: "/child/programs" },
  { label: "الألعاب", icon: "/images/waei-child/icons/games-3d.svg", href: "/dashboard/games" },
