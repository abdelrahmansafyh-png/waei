...
export default function ChildSidebar({ profile, activeHref = "/dashboard" }: ChildSidebarProps) {
  ...
  return (
    <aside className="relative z-20 hidden h-screen w-[300px] shrink-0 overflow-y-auto overflow-x-hidden rounded-l-[2.7rem] border-r border-white/20 bg-gradient-to-b from-[#0E9FAA]/96 via-[#137C9A]/96 to-[#14224A]/96 px-5 py-6 text-white shadow-[0_25px_80px_rgba(20,34,74,.32)] backdrop-blur-xl lg:block">
      <div className="pointer-events-none absolute -right-16 -top-16 h-48 w-48 rounded-full bg-white/10 blur-sm" />
      <div className="pointer-events-none absolute -left-20 bottom-10 h-64 w-64 rounded-full bg-[#FFD54A]/22 blur-md" />
      ...
      <div className="relative mb-6 overflow-hidden rounded-[2rem] border border-white/20 bg-gradient-to-br from-[#19C6D4]/86 to-[#6ED46E]/86 p-5 text-center shadow-xl">
          ...
          return (
            <Link
              ...
              className={`group flex items-center gap-4 rounded-[1.4rem] border px-4 py-3.5 text-lg font-black transition hover:-translate-y-0.5 ${
                active
                  ? "border-white/50 bg-gradient-to-l from-[#FFD65A] to-[#FFF1A8] text-[#14224A] shadow-[0_14px_26px_rgba(255,214,90,.25)]"
      ...
      <button
        ...
        className="relative mt-4 flex w-full items-center justify-center gap-3 rounded-[1.4rem] bg-[#FF7AB6] px-5 py-3.5 font-black text-white shadow-lg transition hover:-translate-y-0.5"
      >
